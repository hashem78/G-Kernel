...
DEFINE_LOGGER_DEVICE(log_main, LOGGER_LOG_MAIN, LOGGER_128KB_SIZE)
DEFINE_LOGGER_DEVICE(log_events, LOGGER_LOG_EVENTS, LOGGER_128KB_SIZE)
DEFINE_LOGGER_DEVICE(log_radio, LOGGER_LOG_RADIO, LOGGER_128KB_SIZE)
DEFINE_LOGGER_DEVICE(log_system, LOGGER_LOG_SYSTEM, LOGGER_128KB_SIZE)
